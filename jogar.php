  ...
  <div class="principal">
    <nav class="navbar">
      <a class="navbar-brand">
        <img src="images/logo-sdm.png" width="90" height="30"></a>
  ...
  <div class="telaDenuncia">
    <div class="telaDenuncia-content">
      ...
      <div class="botoesdedenuncia">
        <button class="btn btn-outline-info btn-lg sim-btn denunciado">Sim</button>
